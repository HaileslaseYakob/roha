...
class ShPurchaseAgreement(models.Model):
    ...
    state = fields.Selection([('draft','Draft'),('confirm','Confirmed'),('bid_selection','Bid Selection'),('req_ver_dept','Request Verification'),('verified','Verified'),
                              ('gmapproved','GM Approved'),('closed','Closed'),('cancel','Cancelled')],string="State",default='draft',track_visibility="onchange")
